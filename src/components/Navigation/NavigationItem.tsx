...
const NavigationItem: FC<NavigationItemProps> = ({
													...
													<div>
														<div className="flex flex-wrap items-center gap-1 xl:gap-x-4">
															...
															<Link
																...
																className="relative z-10 rounded-full bg-neutral-50 px-3 py-1.5 text-xs font-medium text-neutral-600"
															>
				...
				{() => (
					<>
						...
						>
							...
							>
								<ul className="bg-white relative grid space-y-1 rounded-2xl py-3 text-sm shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-neutral-900 dark:ring-white dark:ring-opacity-10">
				...
				{() => (
					<>
						...
						>
							<PopoverPanel
								static
								className="sub-menu absolute left-full top-0 z-10 w-56 pl-2 bg-white"
							>
	...
	const renderDropdownMenuNavlink = (item: NavItemType) => {
		return (
			<Link
				className="flex items-center rounded-md px-4 py-2 font-normal text-neutral-600 dark:text-neutral-400"
				href={{
					pathname: item.uri || '',
				}}
			>
	...
	const renderMainItem = (item: NavItemType) => {
		...
		return (
			<div className="nc-menu-lv1 flex h-20 flex-shrink-0 items-center">
				<ItemC
					className="relative inline-flex cursor-pointer items-center rounded-xl px-4 py-2.5 text-sm font-medium text-neutral-700 dark:text-neutral-300"
